  ...
  Scaffold(
    ...
    Column(
      ...
      RememberMeSwitch(
        ...
        onCheckedChange = { newValue -> viewModel.updateShowPassword(newValue) },
      )
      ...
      Row(
        ...
        GOutlinedButton(onClick = { onRegistration() }, enabled = true) {
          Text(text = stringResource(R.string.create_account_button_text))
        }
      }
      
      Spacer(modifier = Modifier.weight(1f))
      GTextButton(onClick = { onResetPassword() }, enabled = true) {

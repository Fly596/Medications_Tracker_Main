...
data class MedicationTypeEntity(@PrimaryKey(autoGenerate = true) val id: Long = 0, val name: String)
...
data class MedicationTypeCrossRef(val medicationId: Long, val medicationTypeId: Long)
...
data class EmotionEntity(@PrimaryKey(autoGenerate = true) val id: Long = 0, val name: String)
...
data class MoodReasonEntity(@PrimaryKey(autoGenerate = true) val id: Long = 0, val name: String)

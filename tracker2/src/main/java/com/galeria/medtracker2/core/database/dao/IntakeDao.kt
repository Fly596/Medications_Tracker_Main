...
interface IntakeDao {
    ...
    @Insert(onConflict = OnConflictStrategy.REPLACE) suspend fun upsert(intake: IntakeLogEntity)
    ...
    @Query("DELETE FROM intake_logs WHERE id = :id") suspend fun deleteById(id: UUID)
